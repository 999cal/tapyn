...
const Index = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-black flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-transparent mb-4">Welcome to Playd</h1>
          <p className="text-slate-300 mb-8">Please sign in to create your gaming and music profile</p>
          <Link to="/">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-black relative overflow-hidden text-white">
      <InteractiveBackground />
      
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 bg-black/90 backdrop-blur-sm border-b border-sky-400/30 z-50 h-16">
          ...
          <div className="flex items-center gap-4">
            {profile?.username && (
              <div className="text-right">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sky-400 font-medium hover:text-sky-300 transition-colors flex items-center gap-1"
                >
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-sky-400/30 text-slate-400 hover:bg-sky-400/10 hover:border-sky-400"
              >
      ...
      <div className="flex-1 flex pt-16">
        ...
        <div className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-800/90 backdrop-blur-lg rounded-2xl border border-sky-400/30 p-8 shadow-xl">
              <div className="mb-8">
                <h1 className="text-3xl font-bold bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-transparent mb-2">
              ...
              {/* Save & Publish Button */}
              <div className="mt-8 pt-6 border-t border-sky-400/30 flex justify-center">
                <Button
                  onClick={handleSaveAndPublish}
                  disabled={isSaving}
                  className="bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white px-8 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 rounded-full"
                >
                  {isSaving ? (
                    <>
        ...
        {/* Preview Area */}
        <div className="w-80 p-6 border-l border-sky-400/30 bg-slate-800/30 backdrop-blur-sm">
